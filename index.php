...
// RANDOMIZED version - multiple questions per value for variety
$categories = array (
	"WORLD CAPITALS" => array (
		200 => array(
			array("q" => "This French capital city is home to the Eiffel Tower and the Louvre Museum.", "a" => "What is Paris?"),
			array("q" => "This English capital sits on the River Thames and is home to Big Ben.", "a" => "What is London?"),
		...
		400 => array(
			...
			array("q" => "This Spanish capital is home to the Prado Museum and Royal Palace.", "a" => "What is Madrid?"),
	...
	"SCIENCE & NATURE" => array (
		...
		800 => array(
			...
			array("q" => "This scientist's laws of motion form the foundation of classical mechanics.", "a" => "Who is Isaac Newton?"),
	...
	"POP CULTURE" => array (
		...
		800 => array(
			...
			array("q" => "This reality TV family has been 'Keeping Up' since 2007.", "a" => "Who are the Kardashians?")
		),
		1000 => array(
	...
	"HISTORY" => array (
		200 => array(
			...
			array("q" => "This ship sank on its maiden voyage in 1912.", "a" => "What is the Titanic?")
		),
		400 => array(
